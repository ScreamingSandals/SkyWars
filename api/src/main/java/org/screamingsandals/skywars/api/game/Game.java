...
public interface Game {
    ...
    GameTasker getGameTasker();

    void setGameTasker(GameTasker gameTasker);

    GameState getGameState();

    void setGameState(GameState gameState);

    Scoreboard getGameScoreboard();

    void createGameScoreboard();

    void setGameScoreboard(Scoreboard scoreboard);

    void joinToGame(GamePlayer gamePlayer);

    void leaveFromGame(GamePlayer gamePlayer);
